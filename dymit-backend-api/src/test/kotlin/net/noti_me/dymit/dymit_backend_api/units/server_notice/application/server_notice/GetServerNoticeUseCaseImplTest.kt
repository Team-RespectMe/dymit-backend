...
import net.noti_me.dymit.dymit_backend_api.server_notice.application.GetNoticeUseCaseImpl
...
import net.noti_me.dymit.dymit_backend_api.units.server_notice.domain.ServerNoticeTest
        ...
        Given("공지의 ID가 주어진다.") {
            When("존재하는 ID로 조회하면") {
                Then("정상적으로 공지를 반환한다.") {
                    ...
                    val result = usecase.execute(existsId)
