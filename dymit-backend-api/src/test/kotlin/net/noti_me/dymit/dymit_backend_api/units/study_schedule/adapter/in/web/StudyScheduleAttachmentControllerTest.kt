...
import net.noti_me.dymit.dymit_backend_api.study_schedule.application.usecase.dto.StudyScheduleFileThumbnailDto
import net.noti_me.dymit.dymit_backend_api.common.security.jwt.MemberInfo
import net.noti_me.dymit.dymit_backend_api.study_schedule.adapter.`in`.web.StudyScheduleAttachmentController
...
internal class StudyScheduleAttachmentControllerTest : BehaviorSpec() {
    ...
    private fun createAttachmentDto(
        ...
        return StudyScheduleAttachmentDto(
            ...
            thumbnail = StudyScheduleFileThumbnailDto(
