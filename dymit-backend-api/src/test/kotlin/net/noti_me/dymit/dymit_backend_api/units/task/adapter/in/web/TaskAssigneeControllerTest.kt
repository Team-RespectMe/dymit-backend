...
import net.noti_me.dymit.dymit_backend_api.task.adapter.`in`.web.TaskAssigneeController
        ...
        Given("과제 제출 대상 목록 조회 요청이 주어지면") {
            When("컨트롤러가 응답을 생성하면") {
                Then("서비스 결과를 ListResponse와 assigneeId 쿼리 기반 HATEOAS 응답으로 변환한다") {
                    ...
                    val response: ListResponse<net.noti_me.dymit.dymit_backend_api.task.application.port.`in`.web.dto.TaskAssigneeResponse> =
