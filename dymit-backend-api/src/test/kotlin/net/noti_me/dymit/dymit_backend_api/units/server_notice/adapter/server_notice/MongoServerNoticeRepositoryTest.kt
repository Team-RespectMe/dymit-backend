package net.noti_me.dymit.dymit_backend_api.units.server_notice.adapter
...
import net.noti_me.dymit.dymit_backend_api.server_notice.adapter.out.persistence.MongoServerNoticeRepository
...
class MongoServerNoticeRepositoryTest(
    ...
    @Test
    fun `엔티티 수정 테스트`() {
        val writer = createServerNoticeMemberDto(createMemberEntity(
            id = notice.writer.id,
        ...
        notice.updateContent(writer.toRequester(), newContent)
        notice.updateTitle(writer.toRequester(), newTitle)
