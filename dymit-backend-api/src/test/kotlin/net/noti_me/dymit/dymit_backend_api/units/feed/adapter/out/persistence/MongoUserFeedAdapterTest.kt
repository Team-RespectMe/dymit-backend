package net.noti_me.dymit.dymit_backend_api.units.feed.adapter.out.persistence
...
import net.noti_me.dymit.dymit_backend_api.feed.adapter.out.persistence.MongoUserFeedAdapter
...
class MongoUserFeedAdapterTest(
    private val mongoTemplate: MongoTemplate
) : AnnotationSpec() {

    private val mongoUserFeedRepository = MongoUserFeedAdapter(mongoTemplate)
