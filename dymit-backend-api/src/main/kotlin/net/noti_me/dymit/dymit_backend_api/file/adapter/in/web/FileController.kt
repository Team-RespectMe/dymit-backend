package net.noti_me.dymit.dymit_backend_api.file.adapter.`in`.web
...
import net.noti_me.dymit.dymit_backend_api.file.application.port.`in`.web.FileApi
import net.noti_me.dymit.dymit_backend_api.file.application.port.`in`.web.dto.FileUploadRequest
import net.noti_me.dymit.dymit_backend_api.file.application.port.`in`.web.dto.FileUploadResponse
