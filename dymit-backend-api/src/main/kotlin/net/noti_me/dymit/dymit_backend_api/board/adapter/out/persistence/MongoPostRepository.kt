package net.noti_me.dymit.dymit_backend_api.board.adapter.out.persistence
...
class MongoPostRepository(
    ...
    override fun updateWriterInfo(writer: BoardWriterUpdateDto): Int {
        return try {
            ...
            val update = Update().set(
                ...
                Writer.of(
                    ...
                    imageType = writer.profileImageType,
                    imageUrl = writer.profileImageUrl
                )
            )
