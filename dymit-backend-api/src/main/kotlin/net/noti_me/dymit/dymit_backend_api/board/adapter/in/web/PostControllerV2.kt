...
import net.noti_me.dymit.dymit_backend_api.board.application.port.`in`.web.PostApiV2
...
import net.noti_me.dymit.dymit_backend_api.board.application.port.`in`.web.dto.v2.PostCommandResponseV2
