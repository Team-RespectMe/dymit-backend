package net.noti_me.dymit.dymit_backend_api.report.application

import net.noti_me.dymit.dymit_backend_api.report.application.port.`in`.web.dto.ReportCommand
import net.noti_me.dymit.dymit_backend_api.report.application.port.`in`.web.dto.ReportDto
...
import net.noti_me.dymit.dymit_backend_api.report.application.port.`out`.persistence.ReportRepository
...
class ReportServiceImpl(
    ...
    private fun validateAdminRole(memberInfo: MemberInfo) {
        if (!memberInfo.roles.contains(ADMIN_ROLE)) {
