...
//    val id: ObjectId,
    ...
    fun updateName(requester: BoardMember, newName: String) {
    ...
    fun updatePermissions(requester: BoardMember, newPermissions: List<BoardPermission>) {
        if (!hasPermission(requester, BoardAction.MANAGE_BOARD)) {
    ...
    fun hasPermission(member: BoardMember, action: BoardAction): Boolean {
...
//        }
    ...
    fun removePermission(
        ...
        groupMemberRole: BoardMemberRole,
    ...
    fun canWriteByCategory(member: BoardMember, category: PostCategory): Boolean {
        if ( groupId != member.groupId ) {
            return false
        }
