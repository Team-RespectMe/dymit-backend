...
class StudyScheduleAttachmentResponse(
    ...
    val thumbnail: StudyScheduleFileThumbnailResponse? = null,
    ...
    companion object {
        ...
        fun from(dto: StudyScheduleAttachmentDto): StudyScheduleAttachmentResponse {
            return StudyScheduleAttachmentResponse(
                ...
                path = dto.path,
                url = dto.url,
                thumbnail = dto.thumbnail?.let {
                    StudyScheduleFileThumbnailResponse(path = it.path, url = it.url)
                },
                status = dto.status,
...
class StudyScheduleFileThumbnailResponse(
    val path: String,
    val url: String
)
