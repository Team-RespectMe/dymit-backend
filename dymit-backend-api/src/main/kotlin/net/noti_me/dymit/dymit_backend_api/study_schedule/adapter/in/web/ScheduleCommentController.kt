package net.noti_me.dymit.dymit_backend_api.study_schedule.adapter.`in`.web
...
import net.noti_me.dymit.dymit_backend_api.study_schedule.application.port.`in`.web.ScheduleCommentApi
import net.noti_me.dymit.dymit_backend_api.study_schedule.application.port.`in`.web.dto.ScheduleCommentCommandRequest
import net.noti_me.dymit.dymit_backend_api.study_schedule.application.port.`in`.web.dto.ScheduleCommentResponse
